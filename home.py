...
with sta.track(
    ...
    firestore_document_name="recommendations-app-home",
    firestore_key_file='key-firestone.json',  # Use your existing credentials
    firestore_project_name="analytics-for-streamlit-app"  # Your existing project
):
